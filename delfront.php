    ...
    <div class="container" method="post" action="deleteb.php">
		...
		<form method="post" action="deleteb.php" name="reg">
			...
			<div class="form-group ">
			 ...
			 <button type="submit" class="btn control-label" name="submit" id="bt" style="margin-left: 200px; margin-bottom: 30px; background-color:#ffc844;" onclick="validate();"><b>Submit</b></button>
		</form>
    </div>
